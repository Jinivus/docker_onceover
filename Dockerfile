...
RUN gem uninstall puppet --all --force -x

RUN gem install bundler --version 2.2.17
COPY Gemfile /req/Gemfile
RUN bundle install --system --gemfile /req/Gemfile
...
#   gem install r10k --version 3.9.0 && \
#   gem install rake --version 13.0.3 && \
